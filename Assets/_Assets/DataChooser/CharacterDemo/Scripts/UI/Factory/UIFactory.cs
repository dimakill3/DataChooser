...
namespace _Assets.DataChooser.CharacterDemo.Scripts.UI.Factory
{
    public class UIFactory : IUIFactory
    {
        ...
        {
            var prefab = _assetProvider.Load<ChooseWindow.ChooseWindow>(CharacterAssetPaths.ChooseWindowPath);
